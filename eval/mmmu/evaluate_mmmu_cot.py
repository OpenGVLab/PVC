...
from utils.preprocess import build_transform, dynamic_preprocess
...
def evaluate_chat_model():
    prompt = {
        'multiple-choice': 'Please provide a detailed and step-by-step explanation, structured with sections labeled Thought, Step-by-Step Solution, and Answer. If you are uncertain of the correct answer, guess the most likely one.',
        'open': 'Please provide a detailed and step-by-step explanation, structured with sections labeled Thought, Step-by-Step Solution, and Answer. If you are uncertain of the correct answer, guess the most likely one.'
    }
